        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('vendor.register')}}">
                    ...
                    <!-- Added for Agent Form-->
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>
                                    <input type="radio" name="role" value="vendor" autocomplete="off" checked>
                                    {!! __("Vendor") !!}
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label>
                                    <input type="radio" name="role" value="agent" autocomplete="off">
                                    {!! __("Agent") !!}
                                </label>
                            </div>
                        </div>
                        <span class="invalid-feedback error error-radio"></span>
                    </div>
                    <div class="form-group">
                        <label for="term">
                            ...
                            {!! __("I have read and accept the <a href='terms' target='_blank'>Terms</a> and <a href='privacy' target='_blank'>Privacy Policy</a>") !!}
