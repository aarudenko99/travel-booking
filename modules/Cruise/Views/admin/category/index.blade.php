...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb20">
        <h1 class="title-bar">{{__("Cruise Categories")}}</h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 mb40">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form
                        action="{{route('cruise.admin.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}"
                        method="post">
                        @csrf
                        @include('Cruise::admin/category/form',['parents'=>$rows])
                        <div class="">
        ...
        <div class="col-md-8">
            <div class="filter-div d-flex justify-content-between ">
                <div class="col-left">
                    @if(!empty($rows))
                    <form method="post" action="{{url('admin/module/cruise/category/editBulk')}}"
                ...
                <div class="col-left">
                    <form method="get" action="{{url('/admin/module/cruise/category')}} "
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="title">
                                        <a
                                            href="{{url('admin/module/cruise/category/edit/'.$row->id)}}">{{$prefix.' '.$row->name}}</a>
                                    </td>
