...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb20">
        <h1 class="title-bar">{{__("Cruises Availability Calendar")}}</h1>
    </div>
                ...
                <div class="col-md-3" style="border-right: 1px solid #dee2e6;">
                    <ul class="nav nav-tabs  flex-column vertical-nav" id="items_tab" role="tablist">
                        ...
                        <li class="nav-item event-name ">
                            <a class="nav-link" data-id="{{$item->id}}" data-toggle="tab" href="#calendar-{{$item->id}}"
    ...
    @else
    <div class="alert alert-warning">{{__("No cruises found")}}</div>
    @endif
    ...
    var calendarEl,calendar,lastId,formModal;
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('cruise.admin.availability.loadDates')}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('cruise.admin.availability.store')}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
