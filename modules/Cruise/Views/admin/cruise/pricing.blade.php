<div class="panel">
    ...
    <div class="panel-body">
        @if(is_default_lang())
        <h3 class="panel-body-title">{{__("Cruise Price")}}</h3>
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Price")}}</label>
                    <input type="number" min="0" name="price" class="form-control" value="{{$row->price}}"
                        placeholder="{{__("Cruise Price")}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Sale Price")}}</label>
                    <input type="text" name="sale_price" class="form-control" value="{{$row->sale_price}}"
                        placeholder="{{__("Cruise Sale Price")}}">
                </div>
            </div>
            <div class="col-lg-12">
                <span>
            ...
            <div class="g-items">
                ...
                <div class="item" data-number="{{$key}}">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="number" min="0" name="person_types[{{$key}}][price]" class="form-control"
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="number" min="0" __name__="person_types[__number__][price]" class="form-control"
            ...
            <div class="g-items">
                ...
                <div class="item" data-number="{{$key}}">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="number" min="0" name="extra_price[{{$key}}][price]" class="form-control"
