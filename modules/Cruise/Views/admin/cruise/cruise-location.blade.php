<div class="panel">
    <div class="panel-title"><strong>{{__("Cruise Locations")}}</strong></div>
    <div class="panel-body">
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("Real cruise address")}}</label>
            <input type="text" name="address" class="form-control" placeholder="{{__("Real cruise address")}}"
