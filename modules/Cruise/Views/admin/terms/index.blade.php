    ...
    <div class="row">
        <div class="col-md-4 mb40">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{url('admin/module/cruise/attribute/term_store')}}" method="post">
                        @csrf
                        @include('Cruise::admin/terms/form')
                        <div class="">
        ...
        <div class="col-md-8">
            <div class="filter-div d-flex justify-content-between ">
                <div class="col-left">
                    @if(!empty($rows))
                    <form method="post" action="{{url('admin/module/cruise/attribute/editTermBulk')}}"
                ...
                <div class="col-left">
                    <form method="get" action="{{url('/admin/module/cruise/attribute/terms/'.$attr->id)}} "
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="title">
                                        <a
                                            href="{{url('admin/module/cruise/attribute/term_edit/'.$row->id)}}">{{$row->name}}</a>
                                    </td>
