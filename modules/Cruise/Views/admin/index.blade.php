...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb20">
        <h1 class="title-bar">{{__("All Cruise")}}</h1>
        <div class="title-actions">
            <a href="{{url('admin/module/cruise/create')}}" class="btn btn-primary">{{__("Add new cruise")}}</a>
        </div>
    </div>
    ...
    <div class="filter-div d-flex justify-content-between ">
        <div class="col-left">
            @if(!empty($rows))
            <form method="post" action="{{url('admin/module/cruise/bulkEdit')}}"
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="{{$row->status}}">
                                ...
                                <td class="title">
                                    <a href="{{url('admin/module/cruise/edit/'.$row->id)}}">{{$row->title}}</a>
                                </td>
                                ...
                                <td>
                                    <a target="_blank" href="{{ url("/admin/module/review?service_id=".$row->id) }}"
                                ...
                                <td>
                                    <a href="{{route('cruise.admin.edit',['id'=>$row->id])}}"
