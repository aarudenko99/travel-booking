<form action="{{url(app_get_locale(false,false,'/').config('cruise.cruise_route_prefix'))}}" class="form bravo_form"
    method="get">
                    ...
                    <div class="form-content">
                        ...
                        <div class="smart-search">
                            <input type="text" class="smart-search-location parent_text form-control"
                                {{ ( empty(setting_item("cruise_location_search_style")) or setting_item("cruise_location_search_style") == "normal" ) ? "readonly" : ""  }}
                            ...
                            <div class="date-wrapper">
                                <div class="check-in-wrapper">
                                    ...
                                    <div class="render check-in-render">
                                        {{Request::query('start',display_date(strtotime("today")))}}</div>
                                    <span> - </span>
                                    <div class="render check-out-render">
                                        {{Request::query('end',display_date(strtotime("+1 day")))}}</div>
                                </div>
                            </div>
