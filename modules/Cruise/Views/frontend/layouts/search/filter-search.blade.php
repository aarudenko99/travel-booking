    ...
    <form action="{{url(app_get_locale(false,false,'/').config('cruise.cruise_route_prefix'))}}"
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                ...
                @if(count($cruise_category) > 3 and empty($current_category_ids))
            ...
            <div class="item-content">
                <ul>
                    ...
                    <li @if($key> 2 and empty($selected)) class="hide" @endif>
                        <div class="bravo-checkbox">
                            <label>
                                <input @if(in_array($term->id,$selected)) checked @endif type="checkbox" name="terms[]"
                                value="{{$term->id}}"> {!! $translate->name !!}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </li>
