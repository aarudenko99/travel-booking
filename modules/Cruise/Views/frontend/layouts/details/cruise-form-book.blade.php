<div class="bravo_cruise_book_wrap @if(setting_item('cruise_enable_inbox')) has-vendor-box @endif">
    <div class="bravo_cruise_book">
        <div id="bravo_cruise_book_app" v-cloak>
            @if($row->discount_percent)
            <div class="cruise-sale-box">
            ...
            <div v-html="html"></div>
            @if(!$vendor && !$admin && !$agent)
            <div class="submit-group" id="book_sub_block">
            ...
            @endif
            <input type="hidden" name="pre_agent_id" id="pre_agent_id" value="{{$pre_agent_id}}">
        </div>
    </div>
</div>