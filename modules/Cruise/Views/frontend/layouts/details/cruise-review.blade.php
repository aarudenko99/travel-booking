@if(setting_item("cruise_enable_review"))
        ...
        <div class="review-item">
            ...
            <div class="review-item-body">
                ...
                <ul class="review-star">
                    @for( $i = 0 ; $i < 5 ; $i++ ) @if($i < $item->rate_number)
        ...
        <div class="form-wrapper">
            ...
            <form action="{{ url(app_get_locale()."/review") }}" class="needs-validation" novalidate method="post">
                ...
                <div class="row">
                    ...
                    @if($cruise_review_stats = setting_item("cruise_review_stats"))
                    @php $cruise_review_stats = json_decode($cruise_review_stats) @endphp
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group review-items">
                            @foreach($cruise_review_stats as $item)
                            <div class="item">
                ...
                <div class="text-center">
                    ...
                    <input type="hidden" name="review_service_type" value="cruise">
