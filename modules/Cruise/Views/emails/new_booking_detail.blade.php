...
?>
<div class="b-panel-title">{{__('Cruise information')}}</div>
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        ...
        @endif
        <tr>
            <td class="label">{{__('Cruise name')}}</td>
            <td class="val">
        ...
        <tr>
            ...
            <td class="val no-r-padding">
                <table class="pricing-list" width="100%">
                    ...
                    @else
                    <tr>
                        <td class="label">{{__("Guests")}}: {{$booking->total_guests}}
                            {{format_money($booking->getMeta('base_price'))}}</td>
                        <td class="val no-r-padding">
