...
class CreateCruiseDatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('bravo_cruises', function (Blueprint $table) {
            $table->tinyInteger('default_state')->default(1)->nullable();
        });
        Schema::create('bravo_cruise_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_cruise_dates');
    }
}
