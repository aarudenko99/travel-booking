...
@section('content')
    ...
    <form action="{{route('space.admin.addSpaceFromCsv')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="container-fluid" style="margin-top: 10px;">
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-title"><strong>{{__('Add new Space from CSV')}}</strong></div>
                            <div class="panel-body">
                                <div class="form-group">
