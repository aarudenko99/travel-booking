...
// $user_type = $user->has_role();
$user_type = Auth::user()->hasRole('administrator');
// dd(Auth::user()->hasRole('administrator'));
?>
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="{{url('/admin')}}">CROOATIA</a></h3>
</div>
        ...
        <div class="dropdown header-widget widget-user">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item"
                    href="{{url('admin/module/user/password/'.$user->id)}}">{{__('Change Password')}}</a>
                @endif
