<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="text" class="form-control email" name="email" autocomplete="off" placeholder="{{__('Email address')}}">
    ...
    <div class="form-group">
        <input type="hidden" class="form-control agent-id login-agent-id" name="agent_id" autocomplete="off" id="login_agent_id">
    </div>
    <div class="form-group">
