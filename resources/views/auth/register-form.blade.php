<form class="form bravo-form-register" method="post">
    ...
    <div class="form-group">
        <input type="hidden" class="form-control agent-id login-agent-id" name="agent_id" autocomplete="off">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="term">
            ...
            {!! __("I have read and accept the <a href=':link' target='_blank'>Terms</a> and <a href=':link_privacy'
                target='_blank'>Privacy Policy</a>",['link'=>get_page_url(setting_item('booking_term_conditions')),
            'link_privacy'=>url('page/privacy')]) !!}
